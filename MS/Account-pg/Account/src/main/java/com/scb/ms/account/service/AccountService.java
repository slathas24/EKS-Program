...
public class AccountService 
{
    ...
    {
		System.out.println(customer_url+customer_port);
		...
		System.out.println(uri);
 		...
 		acctStmnt.setCustid(cust.getCustid());
 		acctStmnt.setAddress(cust.getAddress());
 		acctStmnt.setCustfullname(cust.getCustfullname());
 		acctStmnt.setPhone(cust.getPhone());
 		acctStmnt.setEmail(cust.getEmail());
